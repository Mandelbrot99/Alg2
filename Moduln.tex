...
\end{anm}
\begin{bem}[Fünferlemma]\label{bem2.8}\index{Fünferlemma} Ist ein kommutatives Diagramm von $R$-Modul-homomorphismen mit exakten Zeilen 
	$$\begin{tikzcd}
...
\end{anm}
\begin{bem}[Schlangenlemma]\label{bem2.9}\index{Schlangenlemma}
...
\begin{anm}
	...
	\end{itemize}
\end{anm}
\begin{sa}[Hilbertscher Basissatz]\label{sa3.12}\index{Hilbertscher Basissatz}
