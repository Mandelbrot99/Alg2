...
\end{sa}
	\begin{proof} 
		...
		% Das komische X sah irgendwie besonders aus
	\end{proof}
\begin{bem}
	Sei $\begin{tikzcd}
	0  \arrow{r} & M^{’} \arrow{r}{} & M \arrow{r}{} & M^{''} \arrow{r} & 0
...
\end{bem}
\begin{proof}
	%hier wieder komisches X und die unteren geschweiften klammern? und blitz am ende
	% hier ist was bei den Pfeilen mit der tilde schief gegangen 
