...
\begin{sa}
	...
	\begin{eqnarray*}
		...
		M^{’}& \mapsto & \pi(M^{’}) \\
		\pi^{-1}(L) &\leftmapsto & L % Pfeil muss anders rum
	\end{eqnarray*}
...
\end{sa}
\begin{anm}
	Sei $I$ eine Indexmenge, $M$ ein $R$-Modul. \\
	 \begin{align*}
...
\begin{anm}
	\begin{itemize}
		...
		(d.h. $$\begin{tikzcd}
		0 \arrow{r}& M^{'} \arrow{r}{f}\arrow{d}{b'}& B \arrow{r}{c} \arrow{d}{c'}& C \arrow{r}\arrow{d}{d'} & \ldots\\
