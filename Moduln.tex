...
\begin{proof}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			$m\leq n$: klar.\\
			$m >n:$ Sei $f\in I_m$. Dann ist $b_m(f) \in B_m  = B_n = b_n(I_n)$, also existiert ein Polynom $f_1\in I_n$ mit $b_m(f) = b_n(f_1)= b_m(X^{m-n}f_1)$. Also ist $f- X^{m-n} f_1 \in I_{m-1} \overset{\text{IV}}{\subseteq } R[X] I_n$. Wegen $X^{m-n} f_1 \in R[X] I_n$, folgt $r\in R[X] I_n$
		\end{enumerate}
