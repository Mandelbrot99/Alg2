...
\begin{center}
	\textbf{In Folgenden seien $\AA, \BB$ abelsche Kategorien}
\end{center}
\begin{df}
	Ein \define{$\delta$-Funktor\index{$\delta$-Funktor}} $H=(H^n)_{n\geq 0}$ ist eine Familie additiver Funktoren $H^n:\AA\to \BB$ zusammen mit Homomorphismen $\delta:H^n(C) \to H^{n+1}(A)$ für alle $n\geq 0$ und jede kurze exakte Folge $\begin{tikzcd}
...
\end{df}
\begin{bsp}
	$\AA$ habe genügend viele Injektive, $F:\AA\to \BB$ linksexakt. Dann ist $H:=(R^nF)_{n\geq 0}$ ein $\delta$-Funktor nach \ref{8.3}
\end{bsp}