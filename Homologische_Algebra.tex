...
\begin{sa}
	...
	\begin{enumerate}[label= \alph*)]
		...
		exakte ist.
		\item Eine Folge $\begin{tikzcd}
		0 \arrow{r}& \arrow{r} & N' \arrow{r} & N \arrow{r}& N''
...
\begin{df}
	...
	\begin{enumerate}
		\item[] "'exakt"' $\defi$ $F$ überführt kurze exakte Folgen in $\A$ in kurze exakte Folgen in $\Bbbk$
		\item[] "'linksexakt"' $\defi$ Für jede exakte Folge $\begin{tikzcd}
...
\begin{df}
	...
	\begin{enumerate}
		...
		\begin{minipage}[t]{0.3\textwidth} 
			$$\begin{tikzcd}
			A \arrow[hook]{r}{\iota} \arrow{d}{f} & B\arrow[dash]{dl}{g} \\
			I & 
			\end{tikzcd}$$
		\end{minipage}
	\end{enumerate}
