...
\end{bsp}
\begin{df}\label{9.3}
	Sei $H=(H^n)_{n\geq 0}: \A \to \BB $ ein $\delta$-Funktor. H heißt \define{universell\index{universeller Funktor}} $\defi $ Für jeden $\delta$-Funktor $H'=(H^{'n})_{n\geq 0}: \A \to \BB $ setzt sich jede natürliche Transformation $ f^0: H^0 \Ra H^0 $ eindeutig zu einem Homomorphismus von $\delta$-Funktoren fort, d.h. zu einer Familie $f=(f^{n})_{n \geq 0}$ von natürlichen Transformationen $f^{n}: H^{n} \Ra H^{'n} $ die auf naheliegende Weise mit den $\delta^{'}$ verträglich sind.
\end{df}
\begin{bem}\label{9.4}
